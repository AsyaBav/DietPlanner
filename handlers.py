...
def register_handlers(dp):
    ...
    router.callback_query.register(view_meal_type_plan, F.data.startswith("plan:") & F.data.contains(":") & ~F.data.in_(["plan:add", "plan:generate", "plan:to_diary", "plan:clear", "plan:back"]))
